...
public class AcronymOps
    ...
    public void onConfiguration(Activity activity,
        ...
        if (firstTimeIn) {
            ...
            // Here I have built the RetroFit RestAdapter, which is used to create
            // the RetroFit service instance, and then used it to build
            // the RetrofitAcronymWebServiceProxy.
    ...
    public List<AcronymExpansion> doInBackground(String acronym) {
        try {
            ...
            // service.
                ...
                // Here I am casting results of getAcronymResults to AcronymData
